...
#     for cursor in range(1, len(arr)):
#         print(f"cursor={cursor} item={arr[cursor]}")
#         leftsum = sum(arr[0:cursor])
#         rightsum = sum(arr[cursor+1:len(arr)])
#         if leftsum == rightsum:
#          print(f"{leftsum}--{rightsum}")
#          print(f"-------------------------------->cursor={cursor}--item={arr[cursor]}")
#          print(f"")
#          if answer < arr[cursor]:
#             answer = arr[cursor]
#         else:
#          print(f"{leftsum}--{rightsum}")
#          print(f"")
